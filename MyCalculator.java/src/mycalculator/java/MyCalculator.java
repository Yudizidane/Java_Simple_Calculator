...
String specialButtonText[] = {"C", "HAPUS" };  
...
final int FRAME_WIDTH=425,FRAME_HEIGHT=425;  
final int HEIGHT=40, WIDTH=40, H_SPACE=15,V_SPACE=15;  
...
{  
new MyCalculator("LSN Calculator");  
}  
}  
